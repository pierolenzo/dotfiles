...
plugins=(sudo git zsh-autosuggestions fast-syntax-highlighting colored-man-pages colorize safe-paste microk8s nvm sdk tmux pip cargo fzf django python adb aws fd)
